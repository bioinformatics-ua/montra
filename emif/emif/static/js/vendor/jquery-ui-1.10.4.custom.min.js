    ...
    e.widget("ui.resizable", e.ui.mouse, {
        ...
        _mouseDrag: function(t) {
            ...
            if (this.size.width !== f) {
                i['min-width'] = this.size.width + "px"
            }
            if (this.size.height !== l) {
                i.height = this.size.height + "px"
            }
            r.css(i);
            // TODO:CALLBACK FOR RESIZE OP
            if(this.options.resizableCallback != null){
                this.options.resizableCallback(r, i);
            }
        ...
        _proportionallyResize: function() {
            ...
            for (e = 0; e < this._proportionallyResizeElements.length; e++) {
                ...
                i.css({
                    ...
                    'min-width': s.width() - this.borderDif[1] - this.borderDif[3] || 0
                })
            }
        },
        _renderProxy: function() {
            ...
            if (this._helper) {
                ...
                this.helper.addClass(this._helper).css({
                    'min-width': this.element.outerWidth() - 1,
    ...
    e.ui.plugin.add("resizable", "animate", {
        stop: function(t) {
            ...
            n.element.animate(e.extend(a, l && f ? {
                ...
                step: function() {
                    var r = {
                        width: parseInt(n.element.css("min-width"), 10),
        ...
        resize: function(t, n) {
            var r = e(this).data("ui-resizable"),
                ...
                u = {
                    ...
                    'min-width': r.size.width - s.width || 0,
    ...
    e.extend(i.prototype, {
        ...
        _newInst: function(t, n) {
            ...
            return {
                ...
                drawYear: 0,
                inline: n,
                dpDiv: !n ? this.dpDiv : s(e("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))
            }
        },
