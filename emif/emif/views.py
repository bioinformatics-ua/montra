...
def geo(request, template_name='geo.html'):
    ...
    for database in list_databases:
        ...
        if _loc!= None and g != None and len(_loc)>1:
            ...
            'id' : database.id,
            'admin_name': database.admin_name,
            'admin_address': database.admin_address,
            'admin_email': database.admin_address,
            'admin_phone': database.admin_phone,
            'scien_name': database.scien_name,
            'scien_address': database.scien_address,
            'scien_email': database.scien_email,
            'scien_phone': database.scien_phone,
            'tec_name': database.tec_name,
            'tec_address': database.tec_address,
            'tec_email': database.tec_email,
            'tec_phone': database.tec_phone,
            'lat' : str(city.lat),
            'long': str(city.long),
            })
