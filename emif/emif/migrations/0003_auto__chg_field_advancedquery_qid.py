...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'AdvancedQuery.qid' to match new field type.
        db.rename_column('emif_advancedquery', 'qid', 'qid_id')
        # Changing field 'AdvancedQuery.qid'
        db.alter_column('emif_advancedquery', 'qid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questionnaire.Questionnaire']))
        # Adding index on 'AdvancedQuery', fields ['qid']
        db.create_index('emif_advancedquery', ['qid_id'])


    def backwards(self, orm):
        # Removing index on 'AdvancedQuery', fields ['qid']
        db.delete_index('emif_advancedquery', ['qid_id'])


        # Renaming column for 'AdvancedQuery.qid' to match new field type.
        db.rename_column('emif_advancedquery', 'qid_id', 'qid')
        # Changing field 'AdvancedQuery.qid'
        db.alter_column('emif_advancedquery', 'qid', self.gf('django.db.models.fields.IntegerField')())
