...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdvancedQuery.removed'
        db.add_column('emif_advancedquery', 'removed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdvancedQuery.removed'
        db.delete_column('emif_advancedquery', 'removed')
