...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'AdvancedQuery', fields ['serialized_query_hash']
        db.delete_unique('emif_advancedquery', ['serialized_query_hash'])


    def backwards(self, orm):
        # Adding unique constraint on 'AdvancedQuery', fields ['serialized_query_hash']
        db.create_unique('emif_advancedquery', ['serialized_query_hash'])
