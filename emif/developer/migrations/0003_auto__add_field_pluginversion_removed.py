...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PluginVersion.removed'
        db.add_column('developer_pluginversion', 'removed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PluginVersion.removed'
        db.delete_column('developer_pluginversion', 'removed')
