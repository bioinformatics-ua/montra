...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PluginVersion.submitted_desc'
        db.add_column('developer_pluginversion', 'submitted_desc',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PluginVersion.submitted_desc'
        db.delete_column('developer_pluginversion', 'submitted_desc')
