...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Plugin.icon'
        db.alter_column('developer_plugin', 'icon', self.gf('django_resized.forms.ResizedImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Plugin.icon'
        db.alter_column('developer_plugin', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        'developer.plugin': {
            ...
            'icon': ('django_resized.forms.ResizedImageField', [], {'max_length': '100', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'developer.pluginversion': {
            ...
            'submitted_desc': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'version': ('django.db.models.fields.IntegerField', [], {})
        },
        'developer.versiondep': {
            'Meta': {'ordering': "['-latest_date']", 'object_name': 'VersionDep'},
