...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PluginVersion.path'
        db.alter_column('developer_pluginversion', 'path', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'PluginVersion.path'
        db.alter_column('developer_pluginversion', 'path', self.gf('django.db.models.fields.CharField')(max_length=2000))
