...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AnswerChange'
        db.create_table('fingerprint_answerchange', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('revision_head', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fingerprint.FingerprintHead'])),
            ('answer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fingerprint.Answer'])),
            ('old_value', self.gf('django.db.models.fields.TextField')(null=True)),
            ('new_value', self.gf('django.db.models.fields.TextField')(null=True)),
            ('old_comment', self.gf('django.db.models.fields.TextField')(null=True)),
            ('new_comment', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal('fingerprint', ['AnswerChange'])

        # Adding model 'FingerprintHead'
        db.create_table('fingerprint_fingerprinthead', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fingerprint_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fingerprint.Fingerprint'])),
            ('revision', self.gf('django.db.models.fields.IntegerField')()),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('fingerprint', ['FingerprintHead'])

    def backwards(self, orm):
        # Deleting model 'AnswerChange'
        db.delete_table('fingerprint_answerchange')

        # Deleting model 'FingerprintHead'
        db.delete_table('fingerprint_fingerprinthead')
