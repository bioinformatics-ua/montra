...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Answer'
        db.create_table('fingerprint_answer', (
        ...
        db.send_create_signal('fingerprint', ['Answer'])

        # Adding field 'Fingerprint.questionnaire'
        db.add_column('fingerprint_fingerprint', 'questionnaire',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questionnaire.Questionnaire'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Answer'
        db.delete_table('fingerprint_answer')

        # Deleting field 'Fingerprint.questionnaire'
        db.delete_column('fingerprint_fingerprint', 'questionnaire_id')
