...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AnswerRequest'
        db.create_table('fingerprint_answerrequest', (
        ...
        db.send_create_signal('fingerprint', ['AnswerRequest'])


    def backwards(self, orm):
        # Deleting model 'AnswerRequest'
        db.delete_table('fingerprint_answerrequest')
