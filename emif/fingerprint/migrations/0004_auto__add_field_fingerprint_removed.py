...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fingerprint.removed'
        db.add_column('fingerprint_fingerprint', 'removed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fingerprint.removed'
        db.delete_column('fingerprint_fingerprint', 'removed')
