...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FingerprintSubscription'
        db.create_table('fingerprint_fingerprintsubscription', (
        ...
        db.send_create_signal('fingerprint', ['FingerprintSubscription'])


    def backwards(self, orm):
        # Deleting model 'FingerprintSubscription'
        db.delete_table('fingerprint_fingerprintsubscription')
