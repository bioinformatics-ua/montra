...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnswerRequest.removed'
        db.add_column('fingerprint_answerrequest', 'removed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnswerRequest.removed'
        db.delete_column('fingerprint_answerrequest', 'removed')
