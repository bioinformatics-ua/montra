...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AnswerRequest.date'
        db.alter_column('fingerprint_answerrequest', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'AnswerRequest.date'
        db.alter_column('fingerprint_answerrequest', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
