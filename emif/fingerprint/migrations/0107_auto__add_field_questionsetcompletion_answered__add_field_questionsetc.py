...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionSetCompletion.answered'
        db.add_column('fingerprint_questionsetcompletion', 'answered',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'QuestionSetCompletion.possible'
        db.add_column('fingerprint_questionsetcompletion', 'possible',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionSetCompletion.answered'
        db.delete_column('fingerprint_questionsetcompletion', 'answered')

        # Deleting field 'QuestionSetCompletion.possible'
        db.delete_column('fingerprint_questionsetcompletion', 'possible')
