...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('questionnaire_question', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=2255, null=True))

        # Changing field 'QuestionSet.help_text'
        db.alter_column('questionnaire_questionset', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=2255, null=True))

    def backwards(self, orm):

        # Changing field 'Question.help_text'
        db.alter_column('questionnaire_question', 'help_text', self.gf('django.db.models.fields.CharField')(default='', max_length=2255))

        # Changing field 'QuestionSet.help_text'
        db.alter_column('questionnaire_questionset', 'help_text', self.gf('django.db.models.fields.CharField')(default='', max_length=2255))
