...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionSet.help_text'
        db.add_column('questionnaire_questionset', 'help_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2255, blank=True),
                      keep_default=False)

        # Adding field 'QuestionSet.tooltip'
        db.add_column('questionnaire_questionset', 'tooltip',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Question.tooltip'
        db.add_column('questionnaire_question', 'tooltip',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionSet.help_text'
        db.delete_column('questionnaire_questionset', 'help_text')

        # Deleting field 'QuestionSet.tooltip'
        db.delete_column('questionnaire_questionset', 'tooltip')

        # Deleting field 'Question.tooltip'
        db.delete_column('questionnaire_question', 'tooltip')
