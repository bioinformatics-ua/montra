...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.visible_default'
        db.add_column('questionnaire_question', 'visible_default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.visible_default'
        db.delete_column('questionnaire_question', 'visible_default')
