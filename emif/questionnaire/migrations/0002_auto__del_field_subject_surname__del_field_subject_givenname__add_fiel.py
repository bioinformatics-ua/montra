...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Subject.surname'
        db.delete_column('questionnaire_subject', 'surname')

        # Deleting field 'Subject.givenname'
        db.delete_column('questionnaire_subject', 'givenname')

        # Adding field 'Subject.last_name'
        db.add_column('questionnaire_subject', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Subject.first_name'
        db.add_column('questionnaire_subject', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Subject.user'
        db.add_column('questionnaire_subject', 'user',
    ...
    def backwards(self, orm):
        # Adding field 'Subject.surname'
        db.add_column('questionnaire_subject', 'surname',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Subject.givenname'
        db.add_column('questionnaire_subject', 'givenname',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Subject.last_name'
        db.delete_column('questionnaire_subject', 'last_name')

        # Deleting field 'Subject.first_name'
        db.delete_column('questionnaire_subject', 'first_name')
