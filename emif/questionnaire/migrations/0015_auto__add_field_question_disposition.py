...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.disposition'
        db.add_column('questionnaire_question', 'disposition',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.disposition'
        db.delete_column('questionnaire_question', 'disposition')
