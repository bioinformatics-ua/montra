...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmifProfile.restricted'
        db.add_column('accounts_emifprofile', 'restricted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmifProfile.restricted'
        db.delete_column('accounts_emifprofile', 'restricted')
