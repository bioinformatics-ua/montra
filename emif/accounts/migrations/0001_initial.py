...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmifProfile'
        db.create_table('accounts_emifprofile', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='emif_profile', unique=True, to=orm['auth.User'])),
            ('country', self.gf('django_countries.fields.CountryField')(max_length=2)),
            ('organization', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('accounts', ['EmifProfile'])


    def backwards(self, orm):
        # Deleting model 'EmifProfile'
        db.delete_table('accounts_emifprofile')
