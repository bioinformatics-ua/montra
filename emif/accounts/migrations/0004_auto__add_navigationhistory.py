...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NavigationHistory'
        db.create_table('accounts_navigationhistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('path', self.gf('django.db.models.fields.TextField')()),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('accounts', ['NavigationHistory'])


    def backwards(self, orm):
        # Deleting model 'NavigationHistory'
        db.delete_table('accounts_navigationhistory')
