...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PublicFingerprintShare'
        db.create_table('public_publicfingerprintshare', (
            ...
            ('remaining_views', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('public', ['PublicFingerprintShare'])


    def backwards(self, orm):
        # Deleting model 'PublicFingerprintShare'
        db.delete_table('public_publicfingerprintshare')
    ...
    models = {
        ...
        'public.publicfingerprintshare': {
            'Meta': {'object_name': 'PublicFingerprintShare'},
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'remaining_views': ('django.db.models.fields.IntegerField', [], {}),
