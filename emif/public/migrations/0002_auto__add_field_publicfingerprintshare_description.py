...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PublicFingerprintShare.description'
        db.add_column('public_publicfingerprintshare', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PublicFingerprintShare.description'
        db.delete_column('public_publicfingerprintshare', 'description')
