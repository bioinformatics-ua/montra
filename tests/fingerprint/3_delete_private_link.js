module.exports = {
  "Delete a private link from a database" : function (browser) {
    browser
      ...
      .waitForElementVisible('#public_link_description', 3000, 'Private links popup loads')
      .waitForElementVisible('#public_links_table', 3000, 'Private link appears')
      .click('#public_links_table .privatedelete')
      .pause(1000)
      .waitForElementNotPresent('#public_links_table .privatedelete', 3000, 'Private link removed with success')
      .end();
  }
};
